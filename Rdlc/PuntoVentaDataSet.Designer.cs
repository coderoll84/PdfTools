...
namespace Rdlc {
    ...
    public partial class PuntoVentaDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductosRow AddProductosRow(int IdProveedor, int IdCategoria) {
...
namespace Rdlc.PuntoVentaDataSetTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Productos] WHERE (([Id] = @Original_Id) AND ([IdProveedor] = @" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([IdProveedor], [IdCategoria]) VALUES (@IdProveedor" +
                ", @IdCategoria);\r\nSELECT Id, IdProveedor, IdCategoria FROM Productos WHERE (Id =" +
                " SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Productos] SET [IdProveedor] = @IdProveedor, [IdCategoria] = @IdCategoria WHERE (([Id] = @Original_Id) AND ([IdProveedor] = @Original_IdProveedor) AND ([IdCategoria] = @Original_IdCategoria));
SELECT Id, IdProveedor, IdCategoria FROM Productos WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=localhost;Initial Catalog=PuntoVenta;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, IdProveedor, IdCategoria FROM dbo.Productos";
        ...
        public virtual int Delete(int Original_Id, int Original_IdProveedor, int Original_IdCategoria) {
        ...
        public virtual int Insert(int IdProveedor, int IdCategoria) {
        ...
        public virtual int Update(int IdProveedor, int IdCategoria, int Original_Id, int Original_IdProveedor, int Original_IdCategoria, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IdProveedor, int IdCategoria, int Original_Id, int Original_IdProveedor, int Original_IdCategoria) {
            return this.Update(IdProveedor, IdCategoria, Original_Id, Original_IdProveedor, Original_IdCategoria, Original_Id);
        }
    }
